    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="mb-12 md:mb-16">
          <p className="text-center text-md uppercase tracking-wider text-white mb-2">ABOUT ME</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Latest Blogs (Compact) */}
            <LatestBlogs compact={true} />
          </div>
                ...
                {experiences.map((exp, index) => (
                  <div key={index} className="relative pl-6 pb-6 border-l border-stone-700 last:pb-0">
                    ...
                    <div className="flex flex-wrap items-center mt-1 mb-3">
                      <span className="text-cyan-400 text-sm mr-3">{exp.company}</span>
